...
There are specific spikes in October and January that I think would be interesting to explore or highlight. It also looks like there was a pretty stark drop-off in calls after the beginning of 2023 - especially the very last point, which is lower than any of the points around that same time in 2022. 
```{r daily-calls-plot}
...
Something that I can see now which I didn't notice before was how close some of the unusually high dates are to unusually low dates. This tells me that, although there are broader seasonal trends, spikes and dips can happen on a spontaneous day-by-day basis, meaning it's worth looking into specific days in addition to trying to find broader trends. 
```{r plot-unusual-days}
...
Saturday is the day of the week most likely to see an unusually high amount of calls, with Friday coming close behind it.  
...
Based on what we discussed in class, it would be interesting to dig into the timeline of how batches of fentanyl are dispersed and how those days with spikes could or do correspond with new/bad batches of drugs being dispersed in the county. Specifically, the two dates in the summer that are close to one another - are they two separate events, or a ripple effect from a single dispersion? 
