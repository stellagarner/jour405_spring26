...
The distribution of data is here is relatively normal, as the majority of it falls within the confines of the mean and standard deviation lines. It does skew a little bit towards higher danceability than lower, which seems like a good problem for Spotify to be having. It would be possible to just do a story on the fact that songs had a higher possibility of being danceable in 2020, but I think it would be more interesting to try and find data from past years and compare it with this dataset to see if there are any noticeable differences or trends. 
